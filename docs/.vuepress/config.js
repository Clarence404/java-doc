...
const databaseSidebar = [
    {text: '数据库总览', link: '/database/0_overview'},
    {
        ...
        children: [
            ...
            {text: '特性', link: '/database/1_mysql/1_mysql_feature'},
            {text: 'MariaDB', link: '/database/1_mysql/2_mysql_maria_db'},
            {text: '避坑', link: '/database/1_mysql/3_mysql_fallible_point'},
            {text: '索引', link: '/database/1_mysql/4_topic_mysql_index'},
            {text: '事务与锁', link: '/database/1_mysql/5_topic_mysql_transaction'},
        ],
    },
    {
        text: 'PG 专题',
        ...
        children: [
            ...
            {text: '特性', link: '/database/2_postgresql/1_postgres_feature'},
            {text: 'MVCC', link: '/database/2_postgresql/2_topic_pg_mvcc'},
            {text: '索引', link: '/database/2_postgresql/3_topic_pg_index'},
            {text: 'SQL', link: '/database/2_postgresql/4_topic_pg_advanced_sql'},
        ],
    },
    {
        text: '关系型生态',
    ...
    {
        text: '运维架构',
        link: '/database/5_ops/0_cdc_tools',
        collapsible: true,
        collapsed: true,
        children: [
            {text: 'CDC', link: '/database/5_ops/0_cdc_tools'},
            {text: '备份恢复', link: '/database/5_ops/1_backup_recovery'},
            {text: '分库分表', link: '/database/5_ops/2_sharding'},
            {text: '连接池', link: '/database/5_ops/3_connection_pool'},
        ],
    },
    {
        text: '选型源码',
        ...
        collapsed: true,
        children: [
            {text: 'MBCJ', link: '/database/6_misc/0_mbcj_source_code'},
            {text: '选型', link: '/database/6_misc/1_db_ranking_selection'},
        ],
    },
